...
export function IdentityTerminal() {
  ...
  useEffect(() => {
    ...
    function composeTransforms() {
      ...
      const popZ = clamp(scrollPopElevate * 20 + Math.abs(curScrollVel) * 0.5, 0, 26);
      ...
      if (sheen) {
        sheen.style.background = `radial-gradient(circle 380px at ${localMouseX}px ${localMouseY}px, rgba(138, 160, 255, 0.14), transparent 70%)`;
      }
      ...
      const shadowY = (totalRotX * 2.2 + 10 + popZ * 0.4 + Math.abs(dragCurY) * 0.3).toFixed(1);
